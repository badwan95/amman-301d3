...
//  It refers to the method that the "this" keyword was placed in,so it refers to the object itself
// 2. What is "this" when joe.scopeArrow() is invoked?
//its the window object
// 3. Explain why "this" is different when an arrow function is used.
// because in arrow function "this" keyword is not bound to anything so it returns the window object.

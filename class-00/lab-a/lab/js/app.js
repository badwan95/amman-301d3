...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT: Because the 'rando' variable when we use let definition is now code block scoped instead of a function scoped like "var" definition
  console.log(viewed);
